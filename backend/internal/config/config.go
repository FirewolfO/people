...
func Load() Config {
	return Config{
		...
		PermissionRedirectURIs: split(env("PEOPLE_PERMISSION_REDIRECT_URIS", "http://localhost:5173/oauth/callback,http://127.0.0.1:5173/oauth/callback,http://localhost:5174/oauth/callback,http://127.0.0.1:5174/oauth/callback,http://10.251.237.216:5174/oauth/callback,http://localhost:5178/oauth/callback,http://127.0.0.1:5178/oauth/callback,http://10.251.237.216:5178/oauth/callback")),
